        ...
        render: function (page, data) {
            ...
            for (var i = begin; i < end && i < data.length; i++) {
                li += '<li><div class="img-box">' +
                    '<a class="img-bg" rel="example_group" href="https://github.com/yaxian303/blog/blob/master/photos/' + data[i] + '?raw=true"></a>' +
                    '<img lazy-src="https://github.com/yaxian303/blog/blob/master/photos/' + data[i] + '?raw=true" />' +
                    '</li>';
            }
